/**
 * Real Sage Wallet Integration Example
 *
 * This file provides examples that actually connect to Sage wallet
 * and test custom coin spend creation with WalletConnect.
 */
...
/**
 * Test simple coin spend with Sage wallet
 */
export async function testSimpleCoinSpendWithSage(): Promise<{
  success: boolean
  result?: any
  error?: string
}> {
...
/**
 * Test curried option contract with Sage wallet
 */
export async function testCurriedOptionContractWithSage(): Promise<{
  success: boolean
  result?: any
  error?: string
}> {
...
/**
 * Test multiple coin spends with Sage wallet
 */
export async function testMultipleCoinSpendsWithSage(): Promise<{
  success: boolean
  result?: any
  error?: string
}> {
...
/**
 * Run all Sage wallet integration tests
 */
export async function runAllSageWalletTests(): Promise<void> {
